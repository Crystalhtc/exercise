 ...
 * 
 * Based on the values stored in the 2D array called `student list, initiate a variable called `sentence` to the following sentence (use concatenation):
 ...
 * console log out the variable `sentence`. Write a single line comment as to what will be displayed.
 * 
 */
...
var sentence = "The name of the first student is " + studentList[0][0] + " " + studentList[0][1] + ", and her student number is " + studentList[0][3] + ". She is a student of the " + studentList[0][2] + " program.";
